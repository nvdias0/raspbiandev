...
# THIS VERSIONS KEEPS CHANGES ACROSS CALLS.
...
# 
# At each run, the script runs the image 
# and call the bash command line.
# at exit, the container stops
#
...
#
#
# By default this script downloads ubuntu and installs every needed software.
# this takes a lot of time.
# alternatively you may first download a pre-prepared image beofre running this script for the first time:
#
# docker pull nvdias/raspbiandev:latest
